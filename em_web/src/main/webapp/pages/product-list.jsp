					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li id="${v}"><a href="${pageContext.request.contextPath}/product/findAll?page=${v}&size=${pageInfo.pageSize}">${v}</a></li>
								</c:forEach>
	...
	<script>
		...
		$(function () {
			$("button[title='删除']").click(function () {
				...
				$("#dataList input[type='checkbox']:checked").each(function(){ //遍历checkbox的选择状态
		...
		$(function () {
			$("select").change(function () {
				window.location.href="${pageContext.request.contextPath}/product/findAll?page=${pageInfo.pageNum}&size="+$(this).find("option:checked").val();
			});
		});
