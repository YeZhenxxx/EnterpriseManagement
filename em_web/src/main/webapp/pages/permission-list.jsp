									...
									<c:forEach items="${permissionList}" var="permission">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/permission/queryPermissionDetail?permissionId=${permission.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/permission/delPermissionByPermissionId?permissionId=${permission.id}" class="btn bg-olive btn-xs">删除权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
