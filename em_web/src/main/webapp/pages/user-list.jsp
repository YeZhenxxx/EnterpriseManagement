									...
									<c:forEach items="${userList.list}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/findRolesAndPermissionByUserId?id=${user.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/user/findNoHaveRoleByUserId?userId=${user.id}" class="btn bg-olive btn-xs">添加角色</a>
												<a href="${pageContext.request.contextPath}/user/findHaveRoleByUserId?userId=${user.id}" class="btn bg-olive btn-xs">删除角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<c:forEach begin="1" end="${userList.pages}" step="1" var="v">
								<li><a href="${pageContext.request.contextPath}/user/findAll?page=${userList.pageNum}&size=${userList.pageSize}">${v}</a></li>
								</c:forEach>
		...
		<script>
			...
			$(function () {
				$("select").change(function () {
					window.location.href="${pageContext.request.contextPath}/user/findAll?page=1&size="+$(this).find("option:checked").val();
				});
