					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="permissionName"
								placeholder="角色名称" value="${permission.permissionName}">
						</div>
						<div class="col-md-2 title">权限资源路径</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="url"
								placeholder="角色描述" value="${permission.url}">
						</div>
					</div>
				</div>
			 </section>
	...
	<script>
		...
		$(function () {
			$("button[type='submit']").click(function () {
				$.ajax({
					url:"${pageContext.request.contextPath}/permission/updatePermissionDetails",
