						...
						<div class="table-box">
							...
							<table id="dataList"
								...
								<tbody>
									...
									<c:forEach items="${requestScope.pageInfo.list}" var="orders">
										<tr>
											...
											<td class="text-center">
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findById?id=${orders.id}'">订单</button>
												...
												<button type="button" class="btn bg-olive btn-xs" onclick="location.href='${pageContext.request.contextPath}/orders/findById?id=${orders.id}'">编辑</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" step="1" var="v" >
                            <li id="${v}"><a href="${pageContext.request.contextPath}/orders/findAll?page=${v}&size=${pageInfo.pageSize}">${v}</a></li>
							</c:forEach>
		...
		$(document).ready(function() {
			...
			$(function () {
				$("button[title='删除']").click(function () {
					var Checklength = $("#dataList td input[type='checkbox']:checked");
			...
			//激活页码
			$(function () {
				$("#${pageInfo.pageNum}").addClass("active");
			});

			//获取每页选择数量下拉框
			$(function () {
				$("select").change(function () {
					window.location.href="${pageContext.request.contextPath}"+"/orders/findAll?page=${pageInfo.pageNum}&size="+$(this).find("option:checked").val();
				});
			});
		});
	</script>
